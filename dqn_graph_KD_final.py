...
SAVE = True # Very important!! True if you want to renew figure data, false otherwise.
...
DPI = 48 # This can be revised, and as I assume this DPI shouldn't be too large or else it will overfit the data, but not too small either, or else the it may underfit the data. I will assume 32~64 will be worth trying, and see which gives better performance.
...
for i in xrange(len(train_data)): # Some of the images won't be used due to the length of relative_close_price is shorter than the data_length.
	...
	file_dir = "/home/airchen/Documents/coding/stock/Test32/Test32_"+str(i)+".png" # This file_dir is very important since it is the directory you get your images. Sometimes we won't save the images, we will want to use the already existed ones. Please specify the file_dir by following this example.
...
for i in xrange(len(train_data),data_length):
	...
	file_dir = "/home/airchen/Documents/coding/stock/Test32/Test32_"+str(i)+".png"
        temp = np.asarray(get_img(file_dir))
